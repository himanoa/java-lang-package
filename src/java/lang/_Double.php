...
class _Double extends Number /* implements Serializable, Comparable */
{
     ...
     */
    public static function doubleToLongBits($a = null)
    {
        throw new NotImplementedException(__METHOD__);
    }
     ...
     */
    public static function doubleToRawLongBits($a = null)
    {
        throw new NotImplementedException(__METHOD__);
    }
     ...
     */
    public static function longBitsToDouble($a = null)
    {
        throw new NotImplementedException(__METHOD__);
    }
     ...
     */
    public static function parseDouble($a = null)
    {
        throw new NotImplementedException(__METHOD__);
    }
